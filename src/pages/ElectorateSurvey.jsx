...
import ElectoratesTable from "../features/electorate-survey/components/ElectoratesTable";
...
const ElectorateSurvey = () => {
  ...
  return (
    <>
      <Row type="horizontal">
        <Heading as="h2">ELECTORATES SURVEY</Heading>
...
export default ElectorateSurvey;
