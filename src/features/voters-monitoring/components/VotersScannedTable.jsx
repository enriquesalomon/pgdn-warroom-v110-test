...
function VotersScannedTable() {
  ...
  console.log("votersscanned", JSON.stringify(electorates));
  ...
  return (
    <Menus>
      ...
      <div className="mt-4">
        ...
        <Table columns="0.5fr 2.5fr 1.8fr 1.8fr 3fr 1.8fr 1.8fr 1.8fr 1.8fr">
          <Table.Header>
            <div>#</div>
            <div>Scanned At</div>
          ...
          {isPending ? (
            ...
            <>
              ...
              />
              <Table.Footer>
                <Pagination count={count} set_pagesize={100} />
              </Table.Footer>
            </>
          )}
        </Table>
