...
function ElectorateValidatedTable() {
  ...
  let filter_result = searchParams.get("result") || "ALL";
  let validationType = "SURVEY";

  const csvConfig = mkConfig({
    showTitle: true,
    title: `SURVEY REPORT | ${validationType}`,
    fieldSeparator: ",",
    filename: `electorates survey`,
    decimalSeparator: ".",
    ...
    <Menus>
      ...
      <div className="mt-6" ref={componentRef}>
        ...
        >
          ...
          <p>{brgy} LIST</p>
          <p>
            Filter by: {filter_result} ({validationType})
          </p>
          <p>
