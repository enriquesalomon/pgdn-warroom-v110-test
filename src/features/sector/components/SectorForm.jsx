...
import { useEditSector } from "../hooks/useEditSector";
...
function SectorForm({ sectorToEdit = {}, onCloseModal }) {
  const queryClient = useQueryClient();

  const { isCreating, createSector } = useCreateSector();
  const { isEditing, editSector } = useEditSector();
