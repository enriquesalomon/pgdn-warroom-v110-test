...
import { useCreateAttendees } from "../hooks/useCreateAttendees";
import { useEditAttendees } from "../hooks/useEditAttendees";
...
function CreateForm({ servicetoEdit = {}, onCloseModal }) {
  ...
  const { isCreating, createAttendees } = useCreateAttendees();
  const { isEditing, editAttendees } = useEditAttendees();
