    ...
    <>
      {!showCard ? (
        ...
        <>
          ...
          <div
            ref={cardRef}
            className="w-[300px] h-[500px] mx-auto bg-white rounded-lg overflow-hidden border-2 border-green-400 relative"
            style={{
          ...
          >
            <div className="px-6 py-4 flex items-center justify-center relative z-20">
              <img
                src={companyLogo}
                alt="Company Logo"
                className="h-32 w-auto relative z-10 mt-8"
              />
            </div>
              ...
              <div className="flex items-center">
                <div className="relative">
                  <img
                    src={pic}
                    alt="User"
                    className="h-[120px] w-[120px] rounded-lg border-2 border-green-400"
                  />
                  <div
                    className="absolute top-0 left-0 h-full w-full border-2 border-green-400 rounded-lg"
                    style={{
            ...
            <div className="bg-gray-200 px-6 py-4 text-center absolute bottom-0 left-0 right-0">
              <p className="text-xs text-gray-600">
                This ID card is the property of Kumalarang EPS. Unauthorized use
                is prohibited.
              </p>
            </div>
          </div>
          ...
          <div
            ref={backCardRef}
            className="w-[300px] h-[500px] mx-auto bg-white rounded-lg overflow-hidden border-2 border-green-400 relative mt-8"
            style={{
