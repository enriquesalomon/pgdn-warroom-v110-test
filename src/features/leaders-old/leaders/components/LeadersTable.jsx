...
function LeadersTable() {
  ...
  const { isPending, electorates, count } = useLeader(debouncedSearchTerm);
  ...
  const csvConfig = mkConfig({
    ...
    fieldSeparator: ",",
    filename: `LEADERS`, // export file name (without .csv)
    decimalSeparator: ".",
  ...
  const params = {
    page: "Leaders",
    action: "Exported the Leaders Data to Excel File",
  ...
  return (
    <Menus>
      ...
      <Table columns="2.5fr 1fr 1fr 1fr 1fr 1.8fr 1.8fr 1fr  1fr">
        <Table.Header>
          <div>Name</div>
          <div>Precinct #</div>
          <div>Type</div>
