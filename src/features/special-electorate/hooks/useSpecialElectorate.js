...
import { getUnvalidated_Electorates } from "../../../services/apiElectorates";
...
export function useSpecialElectorate(searchTerm) {
  ...
  const queryKey = ["special_electorate", assigned, page, brgy, searchTerm];
  ...
  useEffect(() => {
    ...
    if (page < pageCount) {
      queryClient.prefetchQuery({
        queryKey: ["special_electorate", page - 1],
