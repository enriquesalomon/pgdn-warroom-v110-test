...
function SignupForm({
  ...
  const isAllowedAction = parseAction(actionPermission, "update user");
  const {
    id: editId,
    email,
    page_permission,
      ...
      signup(
        {
          ...
          createdby: userData?.user_metadata?.fullname,
          ...
          <div className="flex justify-center items-center mt-5">
            <div className="flex flex-col w-full max-w-4xl">
              <div className="flex flex-col md:flex-row">
                <div className="w-full md:w-3/4 p-4 rounded-lg shadow-lg">
                  Page Permission
                  <CheckBorder>
                    <CheckboxList
                      isWorking={isWorking}
                ...
                <div className="w-full md:w-3/4 p-4 rounded-lg shadow-lg mt-4 md:mt-0 md:ml-4">
                  Action Permission
                  <CheckBorder>
                    <CheckboxListAction
                      isWorking={isWorking}
