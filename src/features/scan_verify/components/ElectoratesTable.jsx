...
// import { useUnvalidatedElectorates } from "../hooks/useSpecialElectorate";
import PaginationTblModal from "../../../ui/PaginationTblModal";
import { useUnscanned_Voters } from "../hooks/useScannedVoters";
function ElectoratesTable({ onSelectElectorate, onCloseModal }) {
  ...
  const { isPending, electorates, count } =
    useUnscanned_Voters(debouncedSearchTerm);
